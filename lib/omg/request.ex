defmodule OmgWeb.Request.Api do

  @default_service_url "http://localhost:4000"

  @doc"""

  This Request and Parsing Module is Adapted from
  https://github.com/work-samples/myclient/blob/master/lib/myclient/api.ex
  See Also
  https://medium.com/@a4word/oh-the-api-clients-youll-build-in-elixir-f9140e2acfb6

  NOTE: Reasons this was chosen as a starting point:
    - decent parsing of responses by content-type header
    - simple enough read to adapt easily
